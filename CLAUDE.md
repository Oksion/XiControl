...
Mi-кнопка и «мёртвые» клавиши, авто-герцовка (по питанию + удержание частоты), запоминание яркости
по питанию, «режим совы», тачпад и сенсорный экран вкл/выкл, мёртвая зона у нижнего края тачпада,
