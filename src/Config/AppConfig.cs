...
public sealed class AppConfig
{
    ...
    /// TM2424. Поддерживаются все именованные слоты полного OEM-диспетчера: Mi down/up,
    /// projection, screenshot, taskView, settings, AI down/up, mic, backlight,
    /// touchpad state/toggle, Fn/Caps/Num Lock, performance, Game Center, calculator,
    /// lowPower, refreshRate, Win Lock и cameraPrivacy;
    /// значение — код в виде <c>"0x18"</c> (как в
