...
Важно понимать, что зона делает: она гасит **начало** касания. Палец, впервые опущенный в
полосу, не двигает курсор и не даёт тап — а вот жест, начатый выше, продолжает работать до
самого низа панели, так что прокрутка и перетаскивание не рвутся. **Нажатие в зоне
