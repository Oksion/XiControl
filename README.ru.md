...
- ⚡ **Режимы производительности**: Эко (скрытый режим прошивки) / Тихий / Баланс / Авто /
  Турбо / Полная мощность. **Любой можно убрать с глаз** в Настройки → Производительность —
  два остаются всегда, чтобы было из чего выбирать. Это нужно потому, что набор зависит от
  модели: на Book Pro 14 прошивка не принимает Баланс, а на Redmi Book Pro 15 2022 работают
  только Тихий и Баланс. Поэтому Баланс по умолчанию скрыт — включи, если твой ноутбук его
  принимает.
