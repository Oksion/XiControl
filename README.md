...
- **Learning can be switched off** (the "Curve learning" toggle) — for when the curve is already
  tuned to your taste: brightness tweaks become *temporary* and the curve stays intact. What
  happens next is up to "**Return to learned**": *Always* — after a minute brightness gently
